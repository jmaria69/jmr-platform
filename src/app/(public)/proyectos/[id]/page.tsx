        ...
        <section className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
            ...
            <div className="rounded-2xl glass border-gradient p-8">
                ...
                <div className="flex gap-3">
                    {project.url && <a href={project.url} target="_blank" rel="noopener noreferrer" className="px-6 py-3 rounded-xl text-white font-semibold" style={{ background: project.color }}><ExternalLink className="inline h-4 w-4 mr-2" />Ver demo</a>}
                    <Link href="/proyectos" className="px-6 py-3 rounded-xl bg-white/5 hover:bg-white/10 text-white font-semibold">Otros proyectos</Link>
                </div>
            </div>
        </section>
    );
